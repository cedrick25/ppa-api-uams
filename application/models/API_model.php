<?php 
	...
	class API_model extends CI_Model
	{
		...
		public function authenticate($payload){
	    	...
	    	if($referer !== 'unified.probation.gov.ph' && $referer !== '192.168.1.36'  && $referer !== '192.168.100.3' && $referer !== '192.168.100.14' && $referer !== '192.168.100.14' && $referer !== '192.168.10.199' && $referer !== '192.168.100.4' && $referer !== '192.168.254.115' && $referer !== '192.168.1.219' && $referer !== '127.0.0.1' && $referer !== 'ks' && $referer !== '202.90.136.122' && $referer !== '192.168.0.109'){
		...
		public function Email() 
	    {
			...
			if ($payload != null) {
	            ...
	            $email_config = Array(
	                ...
	                'smtp_pass' => 'Ppa_notification2022',
	                'mailtype'  => 'html',
	                'charset' => 'utf-8',
	                'starttls'  => 'true',
	                'newline'   => "\r\n"
